<script lang="ts">
    ...
    import TagInput from '../../Form/Input/Tag/TagInput.svelte';
...
<form>
    ...
    <FormControl label="Tags" let:id>
        <TagInput {id} placeholder="Tags" inputClassName="c-form-control__input" bind:value={writeDive.tags} />
    </FormControl>
</form>
